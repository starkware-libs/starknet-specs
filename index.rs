...
pub type Size = i64;
pub type StructMember = Vec<StructMember>;
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq, Builder, Default)]
#[builder(setter(strip_option), default)]
#[serde(default)]
...
pub type ContaractABI = Vec<ContractABIEntry>;
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq, Builder, Default)]
#[builder(setter(strip_option), default)]
#[serde(default)]
...
///
pub type Transactions = Vec<Transactions>;
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq, Builder, Default)]
#[builder(setter(strip_option), default)]
#[serde(default)]
...
///
pub type StorageEntries = Vec<Params>;
/// ContractStorageDiffItems
///
...
#[builder(setter(strip_option), default)]
#[serde(default)]
pub struct ContractStorageDiffItems {
    pub address: Address,
    pub storage_entries: StorageEntries,
}
pub type StorageDiffs = Vec<ContractStorageDiffItems>;
pub type DeprecatedDeclaredClasses = Vec<FieldElement>;
pub type DeclaredClasses = Vec<Params>;
...
pub type ReplacedClasses = Vec<Params>;
pub type Nonces = Vec<Params>;
/// StateDiff
///
...
#[builder(setter(strip_option), default)]
#[serde(default)]
pub struct ObjectOfTypeRNPe3TED {
    #[serde(rename = "type")]
    pub _type: Type,
}
/// ActualFee
...
///
pub type FeeEstimate = Vec<FeeEstimate>;
/// False
///
...
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
#[serde(untagged)]
pub enum StarknetGetBlockWithTxHashesResult {
...
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
#[serde(untagged)]
pub enum  {
    BlockId(BlockId),
    Address(Address),
    ...
    Params(Params),
    StarknetGetBlockWithTxHashesResult(StarknetGetBlockWithTxHashesResult),
...
pub fn StarknetGetBlockWithTxHashes(&mut self, block_id: BlockId) -> RpcRequest<StarknetGetBlockWithTxHashesResult>;
...
pub fn StarknetEstimateFee(&mut self, request: BroadcastedTransaction, block_id: BlockId) -> RpcRequest<FeeEstimate>;
...
pub fn StarknetGetEvents(&mut self, filter: Params) -> RpcRequest<EventsChunk>;
